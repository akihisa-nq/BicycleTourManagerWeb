...
class TourPlan < ActiveRecord::Base
	...
	def self.generate(id)
		...
		system("wkhtmltopdf --disable-smart-shrinking -s A4 -O Landscape -L 25mm -R 25mm -T 4mm -B 4mm #{html_path} #{plan.pdf_path()}")
		...
		system("wkhtmltopdf --disable-smart-shrinking -s A4 -O Landscape -L 25mm -R 25mm -T 4mm -B 4mm #{html_path} #{plan.public_pdf_path()}")
